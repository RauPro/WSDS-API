...
def set_env():
    ...
    os.environ[
        'OLLAMA-Token'] = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjBmNjg5MTM1LTI1OGUtNDAxNi04NDZkLTNmYjZkNjAyNmNlNyJ9.VlI_R_9WxbW-r5h_FMgm_974w9GnS784fpwe-0SLkTI'
